...
public class Elevator implements Runnable {
            ...
            while (true) {
                ...
                if (checkTo()) {
                    ...
                    if (state == 1) {
                        ...
                        elevatorstate.setText("¡ư " + String.valueOf(onfloor));
                    }
                    move();
                } else {
                    state = 0;
    ...
    private void move() {
        ...
        for (int i = 1; onfloor < destination; i++, onfloor++) {
            if (checkNewTo() == 1 || checkOutsideRequest()) {
                return;
            }
            while (true) {
                clearDoorButton();
        ...
        for (int i = 1; onfloor > destination; i++, onfloor--) {
            ...
            elevatorstate.setText("¡ư " + String.valueOf(onfloor - 1));
        }
    ...
    private int checkDoorButton() {
        if (open.getBackground() == Color.RED) {
            return 1;
        }
        if (close.getBackground() == Color.RED) {
            return 2;
        }
        return 0;
    }
