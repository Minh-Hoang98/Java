...
public class BusBookingSystem {
	...
	private static MyStackBooking1 listBooking=new MyStackBooking1();
	...
	private static void saveCustomer() {
		while(true) {
			try {
				...
				project2_4.SaveCustomer.savefile(listCustomer, path);
	...
	private static void addCustomer() {
		...
		listCustomer=project2_4.SaveCustomer.readfile(path);
